...
function mensagemBoasVindasRevenda(revenda) {
    ...
    return [
        ...
        '',
        '2 - Criar cliente',
        'Use quando o cliente ja tem teste ativo ou vencido, ou quando precisar pedir a criacao de cliente sem teste.',
        '',
        '3 - Renovar cliente',
        ...
        '',
        '6 - Falar com a TOPTEC',
        'Encaminha seu atendimento para nossa equipe.',
        '',
        '7 - Ajuda com configuracao',
        'Mostra o passo a passo para configurar no aparelho do cliente.',
        '',
